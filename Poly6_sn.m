function s_C1 = Poly6_sn(N,s1,s2,y1,y2,ds1,ds2,dds1,dds2,ddds2,plotting)
bx=linspace(s1,s2,N);
dbx=deriv(bx',1);
...
%%spacing
eqn3 = 5*dd*  bx(1)^4+4*ee*  bx(1)^3+3*ff*  bx(1)^2+2*gg*  bx(1)^1+1*hh == ds1/dbx(1);
eqn4 = 5*dd*bx(end)^4+4*ee*bx(end)^3+3*ff*bx(end)^2+2*gg*bx(end)^1+1*hh == ds2/dbx(end);
...
%%3rd deriv
eqn6 = 3*4*5*dd*bx(1)^2+2*3*4*ee*bx(1)^1+1*2*3*ff == ddds2;
